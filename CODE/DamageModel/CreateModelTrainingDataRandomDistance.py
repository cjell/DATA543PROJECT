...
synthetic_rows = []
for _, row in merged_small.iterrows():
    new_row = row.copy()
    new_row['dist_to_fire_km'] = np.random.uniform(5, 50)
    new_row['dist_to_fire_m'] = new_row['dist_to_fire_km'] * 1000
...
full_df.to_csv("CreatedData/TrainingData/ModelTrainingData.csv", index=False)
